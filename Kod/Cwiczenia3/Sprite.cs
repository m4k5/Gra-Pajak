...
namespace Gra
{
    /* Klasa sprite'a czyli obiektu animowanego */
    public class Sprite
    {
        ...
        // zmienna p_direction na potrzeby sterowania krową i świnią
        private int p_direction = 4;
        private Game p_game;
        ...
        public Rectangle Bounds
        {
            get
            {
                Rectangle rect = new Rectangle((int)p_position.X,(int)p_position.Y, p_size.Width, p_size.Height);
                return rect;
            }
        }
        public bool IsColliding(ref Sprite other)
        {
            //test kolizji, czy elementy się zderzają, np. dwa sprite'y
